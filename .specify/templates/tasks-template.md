...
**Tests**: Include test tasks whenever required by constitution constraints or
feature requirements. If a constitution mandates coverage or verification gates,
those tests are NOT optional.
...
- [ ] T004 [P] Configure Native AOT single-file, trimmed, self-contained build pipeline
- [ ] T005 [P] Add performance measurement harness for CPU, memory, and polling cadence
...
- [ ] T006 Define hot-path architecture and zero-allocation constraints
- [ ] T007 [P] Implement `System.Threading.Channels`-based cross-thread pipeline
- [ ] T008 [P] Implement resiliency/reconnect behavior (e.g., `Polly` policies)
- [ ] T009 Create mock provider/test harness for local development workflows
- [ ] T010 Configure error handling and logging infrastructure
- [ ] T011 Setup environment and runtime configuration management
